...
public partial class shop : System.Web.UI.Page
{
    ...
    protected void LoadBrandData()
    {
        ...
        name = DATABASE.GETDATA.everything("tbl_products where type = 'WOMENS SHOES'", "DISTINCT name");
        url = DATABASE.GETDATA.everything("tbl_products where type = 'WOMENS SHOES'", "DISTINCT imageurl");
    }
