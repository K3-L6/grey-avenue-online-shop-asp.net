        ...
        <div class="row">
            <div class="col-md-3" style="font-family:'MS Gothic'; font-size:20px; position:relative;">
                ...
                <div class="li-group">
                    ...
                    <a href="#" class="list-group-item"><span class="glyphicon glyphicon-chevron-right"> TOPS</a>
                    <a href="#" class="list-group-item"><span class="glyphicon glyphicon-chevron-right"> PANTS</a>
                    <a href="#" class="list-group-item"><span class="glyphicon glyphicon-chevron-right"> SKIRTS</a>
                    <a href="#" class="list-group-item"><span class="glyphicon glyphicon-chevron-right"> SHORTS</a>
                    <a href="#" class="list-group-item"><span class="glyphicon glyphicon-chevron-right"> BAGS</a>
                    <a href="#" class="list-group-item"><span class="glyphicon glyphicon-chevron-right"> SHOES</a>
                </div>
