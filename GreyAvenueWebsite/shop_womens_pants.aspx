<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shop_womens_pants.aspx.cs" Inherits="shop" %>
        ...
        <div class="row">
            <div class="col-md-3" style="font-family:'MS Gothic'; font-size:20px; position:relative;">
                ...
                <div class="li-group">
                    ...
                    <a href="shop_womens_pants.aspx" class="list-group-item active"><span class="glyphicon glyphicon-chevron-right"> PANTS</a>
