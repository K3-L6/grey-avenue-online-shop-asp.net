...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        oldFld.Text = INFO.currentUser.contactnumber;
        try
        {
    ...
    protected void changeBtn_Click(object sender, EventArgs e)
    {
        if (InputValid())
        {
            DATABASE.UPDATE.byfield("tbl_customers", "contactnumber", INFO.currentUser.id, newFld.Text);
            INFO.currentUser.contactnumber = newFld.Text;
