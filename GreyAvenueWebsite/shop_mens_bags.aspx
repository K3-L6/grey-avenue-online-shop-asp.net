<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shop_mens_bags.aspx.cs" Inherits="shop" %>
        ...
        <div class="row">
            <div class="col-md-3" style="font-family:'MS Gothic'; font-size:20px; position:relative;">
                ...
                <div class="li-group">
                    ...
                    <a href="shop_womens_shorts.aspx" class="list-group-item"><span class="glyphicon glyphicon-chevron-right"> SHORTS</a>
                    <a href="shop_womens_bags.aspx" class="list-group-item"><span class="glyphicon glyphicon-chevron-right"> BAGS</a>
                ...
                <div class="li-group">
                    ...
                    <a href="shop_mens_bags.aspx" class="list-group-item active"><span class="glyphicon glyphicon-chevron-right"> BAGS</a>
                </div>
            </div>
