<%@ Page Language="C#" AutoEventWireup="true" CodeFile="myaccount_change_password.aspx.cs" Inherits="_Default" %>
        ...
        <div class="mainMyaccount">
            ...
            <form runat="server">
                <div class="content col-md-8 col-md-offset-2">
                    <h1>Password</h1>
                    <h1 style="font-size:15px;">Old Password</h1>
                    <asp:TextBox ID="oldFld" runat="server" class="fld" ReadOnly="false" TextMode="Password"></asp:TextBox>
                    <h1 style="font-size:15px;">New Password</h1>
                    <asp:TextBox ID="newFld" runat="server" class="fld" ReadOnly="false" TextMode="Password"></asp:TextBox>
                    <h1 style="font-size:15px;">Repeat New Password</h1>
                    <asp:TextBox ID="rnewFld" runat="server" class="fld" ReadOnly="false" TextMode="Password"></asp:TextBox>
