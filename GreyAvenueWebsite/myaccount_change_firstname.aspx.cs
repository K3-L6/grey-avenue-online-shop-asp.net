...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        oldFld.Text = INFO.currentUser.firstname;
        try
        {
    ...
    protected void changeBtn_Click(object sender, EventArgs e)
    {
        if (InputValid())
        {
            DATABASE.UPDATE.byfield("tbl_customers", "firstname", INFO.currentUser.id, newFld.Text.ToUpper());
            INFO.currentUser.firstname = newFld.Text.ToUpper();
