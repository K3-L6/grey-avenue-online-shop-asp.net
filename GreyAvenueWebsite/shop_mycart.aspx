<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shop_mycart.aspx.cs" Inherits="shop" %>
    ...
    <!--NAVIGATION BAR-->
        ...
        <div class="row">
            <div class="col-md-3" style="font-family:'MS Gothic'; font-size:20px; position:relative;">
                ...
                <button type="button" class="btn btn-default btn-block btn-lg"><span class="glyphicon glyphicon-shopping-cart"> MY CART</button> 
                <div class="li-group">
            ...
            <div class="col-md-9">
                ...
                <div runat="server" id="mainDiv" class="row">
                    <asp:Label ID="infoHolder" runat="server" Visible="False"></asp:Label>
                </div>
